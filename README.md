...
**Задача 5.** Посчитайте, какое среднее и медианное число студентов на каждом из курсов по факультетам.
...
Решенную лабораторную работу загрузите в ветку `feedback`.
